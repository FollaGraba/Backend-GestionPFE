    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/api/disponibilites/ajouter", "/api/soutenance/saveAll", "/api/soutenance/all", "/api/soutenance/delete/**","/api/soutenance/update/**")
                        .permitAll() // Ces routes sont publiques
                        .requestMatchers("/api/excel/upload", "/api/excel/soutenances/**")
