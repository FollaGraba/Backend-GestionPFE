...
class FileUploadSalleDispoWidget extends StatefulWidget {
  final List<DataColumn> columns;

  const FileUploadSalleDispoWidget({super.key, required this.columns});

  @override
  State<FileUploadSalleDispoWidget> createState() =>
      _FileUploadSalleDispoWidgetState();
}

class _FileUploadSalleDispoWidgetState
    extends State<FileUploadSalleDispoWidget> {
  ...
  Future<void> uploadFile(Department? selectedDepartment) async {
    ...
    try {
      ...
      Response response = await _dataSource!.uploadFileSalleDispo(
          fileBytes, fileName, selectedDepartment?.nomDept);
          ...
          DropdownButtonFormField<Department>(
            ...
            onChanged: (Department? newValue) {
              setState(() {
                ...
                print('selectedDepartment: ${newValue?.nomDept}');
              });
            },
          ),
          Expanded(
              ...
              child: Padding(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: _dataSource != null
                      ? () => {uploadFile(_selectedDepartment!)}
                      : null,
