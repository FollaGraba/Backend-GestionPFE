    ...
    public ResponseEntity<List<Map<String, Object>>> getSoutenancesByDepartement(@PathVariable Long departementId) {
        ...
        try {
            ...
            List<Map<String, Object>> response = soutenances.stream().map(soutenancesItem -> {
                ...
                map.put("titreSujet", soutenancesItem.getTitreSujet());
                ...
                map.put("dateSoutenance", soutenancesItem.getDateSoutenance());
                map.put("heureSoutenance", soutenancesItem.getHeureSoutenance());
                map.put("salle", soutenancesItem.getSalleSoutenance());
                map.put("filiere", soutenancesItem.getDepartement().getFilieres()); // Obtention du nom de la filière
    ...
    public ResponseEntity<List<Map<String, Object>>> getSoutenancesByFiliere(@PathVariable String nomFiliere) {
        ...
        try {
            ...
            List<Map<String, Object>> response = soutenances.stream().map(soutenancesItem -> {
                ...
                map.put("heureSoutenance", soutenancesItem.getHeureSoutenance());
                map.put("salle", soutenancesItem.getSalleSoutenance());
                map.put("nomDepartement", soutenancesItem.getDepartement().getNomDept());
